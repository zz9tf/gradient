...
from cell_segmentation.experiments.experiment_cellvit_monusac import (
    ExperimentCellVitMoNuSAC,
)
...
if __name__ == "__main__":
    ...
    elif configuration["data"]["dataset"].lower() == "monusac_patched":
        experiment_class = ExperimentCellVitMoNuSAC
    else:
        raise ValueError(
            f"Unknown dataset: {configuration['data']['dataset']}. "
            "Use one of: pannuke, conic, monusac_patched"
        )
    # Setup experiment
