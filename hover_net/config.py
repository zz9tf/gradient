...
class Config(object):
    ...
    def __init__(self):
        ...
        # paths to training, validation and test patches
        self.train_dir_list = [
            "dataset/monusac/train/256x256_164x164",
        ]
        self.valid_dir_list = [
            "dataset/monusac/valid/256x256_164x164",
        ]
        self.test_dir_list = [
            "dataset/monusac/test/256x256_164x164",
        ]

        self.shape_info = {
            "train": {"input_shape": act_shape, "mask_shape": out_shape,},
            "valid": {"input_shape": act_shape, "mask_shape": out_shape,},
            "test": {"input_shape": act_shape, "mask_shape": out_shape,},
        }
